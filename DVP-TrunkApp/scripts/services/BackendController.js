...
(function () {
  ...
  var backendcontroller = function ($http) {
    ...
    var getTrunkList = function () {
      ...
      return $http.get("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunks")
        // return $http.get("http://queuemusic.104.131.67.21.xip.io/DVP/API/1.0.0.0/QueueMusic/Profiles")
        .then(function (response) {
          console.log("BACKENDCONTROLLER-getTrunkList -"+ JSON.stringify(response));
          return response.data;
    ...
    var deleteTrunk = function (id) {
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+id+"/Availability/false")
    ...
    var deleteNumber = function (phoneNumber) {
      ...
      return $http.delete("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+phoneNumber)
    ...
    var createNewNumber= function (createNewNumber) {
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber",createNewNumber)
        .then(function (response) {
          if (response.data && response.data.IsSuccess) {
    ...
    var updateNumber= function (editNumber) {
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+editNumber.PhoneNumber,editNumber)
    ...
    var updateTrunk= function (EditTrunkDataObj) {
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+EditTrunkDataObj.id ,EditTrunkDataObj)
        .then(function (response) {
          if (response.data && response.data.IsSuccess) {
    ...
    var setExternalProfileOnTrunk = function(trunkId,profID){
     ...
     // return {};
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+trunkId+"/SetSipProfile/"+profID)
    ...
    var setCloudeOnTrunk = function(trunkId,cloudeID){
      ...
      return $http.post("http://192.168.0.33:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+trunkId+"/SetCloud/"+cloudeID)

      // /DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/:id/SetSipProfile/:profId
      .then(function (response) {
        if(response.data && response.data.IsSuccess) {
          console.log("BACKENDCONTROLLER - setCloudeOnTrunk "+ JSON.stringify(response.data.Result));
          return response.data.IsSuccess;
        }
        else{
          return {};
    ...
    var setNumberTranslationOnTrunk = function(trunkId,TransID){
      console.log("BACKENDCONTROLLER - setNumberTranslationOnTrunk ");
         ...
         return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+trunkId+"/SetTranslation/"+TransID)
    ...
    var setInboundLimitOnNumber = function(number,LimitID){
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+number+"/SetInboundLimit/"+LimitID)
//PhoneNumberTrunkApi/TrunkNumber/:trNum/SetBothLimit/:limId
    ...
    var setOutboundLimitOnNumber = function(number,LimitID){
      ...
      return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+number+"/SetOutboundLimit/"+LimitID)
//PhoneNumberTrunkApi/TrunkNumber/:trNum/SetBothLimit/:limId
        // /DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/:id/SetSipProfile/:profId
        .then(function (response) {
          if(response.data && response.data.IsSuccess) {
    ...
    var setBothLimitOnNumber = function(number,LimitID){
      console.log("BACKENDCONTROLLER - setBothLimitOnNumber ");
        ...
        return $http.post("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+number+"/SetBothLimit/"+LimitID)
//PhoneNumberTrunkApi/TrunkNumber/:trNum/SetBothLimit/:limId
       // /DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/:id/SetSipProfile/:profId
       .then(function (response) {
       if(response.data && response.data.IsSuccess) {
    ...
    var getTrunkDataById = function (id) {
      ...
      return $http.get("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+id)
        // return $http.get("http://queuemusic.104.131.67.21.xip.io/DVP/API/1.0.0.0/QueueMusic/Profiles")
        .then(function (response) {
    ...
    var getPhoneNumberList = function () {
      ...
      return $http.get("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumbers")
        // return $http.get("http://queuemusic.104.131.67.21.xip.io/DVP/API/1.0.0.0/QueueMusic/Profiles")
        .then(function (response) {
          console.log("BACKENDCONTROLLER-getNumberList -"+ JSON.stringify(response));
          return response.data;
    ...
    var getPhoneNumbersOfTrunk = function (trunkId) {
      ...
      return $http.get("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/Trunk/"+trunkId+"/PhoneNumbers")
    ...
    var getPhonenumberData = function (phoneNumber) {
      ...
      return $http.get("http://127.0.0.1:9898/DVP/API/1.0.0.0/PhoneNumberTrunkApi/TrunkNumber/"+phoneNumber)
        .then(function (response) {
