...
(function () {
  ...
  var backendcontroller = function ($http) {
    ...
    var getHoldMusicList = function () {
      ...
      return $http.get("http://127.0.0.1:9093/DVP/API/1.0.0.0/QueueMusic/Profiles")
    ...
    var deleteMusicProfile = function (name) {
      ...
      return $http.delete("http://127.0.0.1:9093/DVP/API/1.0.0.0/QueueMusic/Profile/"+name)
        ///
    ...
    var updateMusicProfile = function (Attribute) {
      ...
      return $http.put("http://127.0.0.1:9093/DVP/API/1.0.0.0/QueueMusic/Profile/"+Attribute.Name,Attribute)
        //QueueMusic/Profile/
        .then(function (response) {
    ...
    var createNewMusicProfile = function (NewAppDataObj) {
      ...
      return $http.post("http://127.0.0.1:9093/DVP/API/1.0.0.0/QueueMusic/Profile",NewAppDataObj)
        .then(function (response) {
          if (response.data && response.data.IsSuccess) {
